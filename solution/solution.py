...
user_data = min_max.fit_transform(user_data1)

user_id = user_id1.astype(np.float)

train_submission1[: , 3] = min_max.fit_transform(train_submission1[: , 3])
